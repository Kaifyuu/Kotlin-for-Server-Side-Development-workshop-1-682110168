...
// กรองสินค้าหมวด Electronics -> กรองราคามากกว่า 500 -> ดึงราคา -> รวม
...
fun calculateTotalElectronicsPriceOver500Sequence(products: List<Product>): Double =
    products
        .asSequence()
        .filter { it.category == "Electronics" }
        .filter { it.price > 500 }
...
// นับจำนวนสินค้าหมวด Electronics ที่ราคามากกว่า 500 บาท
...
fun main() {
    ...
    val totalElecPriceOver500Sequence = calculateTotalElectronicsPriceOver500Sequence(products)
